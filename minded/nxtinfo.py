...
class NXTInfo(object):
    ...
    def get_brickinfo(self):
        ...
        if self.brick_type == 'ev3':
            ...
            self.widgetlist[11].set_xalign(0)
            self.widgetlist[10].set_text(self.app.ev3brick.get_hw_version())
            self.widgetlist[10].set_xalign(0)
            self.widgetlist[8].set_text('%d KB' % self.app.ev3brick.get_free_mem())
            self.widgetlist[8].set_xalign(0)
            self.widgetlist[7].set_text('OS version:')
            self.widgetlist[7].set_xalign(0)
            self.widgetlist[6].set_text(self.app.ev3brick.get_os_version())
            self.widgetlist[6].set_xalign(0)
            self.widgetlist[4].set_text(self.app.ev3brick.get_fw_version())
            self.widgetlist[4].set_xalign(0)
            self.widgetlist[2].set_text('%s V' % self.app.ev3brick.get_vbatt())
            self.widgetlist[2].set_xalign(0)
