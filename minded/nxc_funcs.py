# -*- coding: utf-8 -*-
nxc_funcs = [
    ['Acquire', 'Acquire()', '<b>Acquire (mutex <span foreground="brown">m</span>)</b>\n\n' +
    ...
    ['ArrayInit', 'ArrayInit(,,)', '<b>ArrayInit (<span foreground="brown">aout[]</span>, ' +
    ...
    ['ArrayLen', 'ArrayLen()', '<b>ArrayLen (<span foreground="brown">data[]</span>)</b>\n\n' +
    ...
    ['BluetoothStatus', 'BluetoothStatus()', '<b>BluetoothStatus (<span foreground="brown">conn</span>)</b>\n\n' +
    ...
    ['ButtonCount', 'ButtonCount()', '<b>ButtonCount (<span foreground="brown">btn</span>, ' +
    ...
    ['ButtonLongPressCount', 'ButtonLongPressCount()', '', 'Button'], 
    ['ButtonPressCount', 'ButtonPressCount()', '<b>ButtonPressCount (' +
    ...
    ['ButtonPressed', 'ButtonPressed()', '<b>ButtonPressed (<span foreground="brown">btn</span>, ' +
        '<span foreground="brown">resetCount</span> = false)</b>\n\n' +
    ...
    ['ButtonState', 'ButtonState()', '<b>ButtonState (<span foreground="brown">btn</span>)</b>\n\n' +
    ...
    ['ClearScreen', 'ClearScreen()', '<b>ClearScreen ()</b>\n\n' +
        'Clear LCD screen. This function lets you clear\n' +
        'the NXT LCD to a blank screen.\n\n' +
        '<b>Example:</b>\n' +
        '  ClearScreen();', 'Display'], 
    ['ClearSensor', 'ClearSensor()', '<b>ClearSensor (<span foreground="brown">port</span>)</b>\n\n' +
    ...
    ['CircleOut', 'CircleOut(,,)', '<b>CircleOut (<span foreground="brown">x</span>,' +
    ...
    ['CreateFile', 'CreateFile()', '', 'Loader'], 
    ['CloseFile', 'CloseFile()', '', 'Loader'],
    ['DeleteFile', 'DeleteFile()', '', 'Loader'],
    ['Float', 'Float()', '<b>Float (<span foreground="brown">outputs</span>)</b>\n\n' +
        'Float motors. Make outputs float. Float is an alias for Coast.\n\n' +
        '<b>Parameters</b>\n' +
        '  <span foreground="brown">outputs</span>  Desired output ports.\n' +
        '<b>Example:</b>\n' +
        '  Float(OUT_A); // float output A', 'Output'],
    ['GraphicOut', 'GraphicOut(,,)', '<b>GraphicOut (<span foreground="brown">x</span>,' +
    ...
    ['LineOut', 'LineOut(,,,)', '<b>LineOut (<span foreground="brown">x1</span>,' +
    ...
    ['NumOut', 'NumOut(,,)', '<b>NumOut (<span foreground="brown">x</span>,' +
    ...
    ['NumToStr', 'NumToStr()', '<b>NumToStr (<span foreground="brown">num</span>)</b>\n\n' +
    ...
    ['OnFwd', 'OnFwd(,)', '<b>OnFwd (<span foreground="brown">outputs</span>, ' +
    ...
    ['OnRev', 'OnRev(,)', '<b>OnRev (<span foreground="brown">outputs</span>,' +
        ' <span foreground="brown">pwr</span>)</b>\n\n' +
    ...
    ['OnFwdReg', 'OnFwdReg(,,)', '<b>OnFwdReg (<span foreground="brown">outputs</span>,' +
    ...
    ['OnFwdRegPID', 'OnFwdRegPID(,,,,,)', '', 'Output'], 
    ['OnFwdSync', 'OnFwdSync(,,)', '<b>OnFwdSync (<span foreground="brown">outputs</span>,' +
    ...
    ['OnFwdSyncPID', 'OnFwdSyncPID(,,,,,)', '', 'Output'],
    ['OnRevReg', 'OnRevReg(,,)', '<b>OnRevReg ( <span foreground="brown">outputs</span>,' +
    ' <span foreground="brown">pwr</span>, <span foreground="brown">regmode</span> )</b>\n\n' +
    ...
    ['OnRevRegPID', 'OnRevRegPID(,,,,,)', '', 'Output'], 
    ['OnRevSync', 'OnRevSync(,,)', '<b>OnRevSync (<span foreground="brown">outputs</span>,' +
        ' <span foreground="brown">pwr</span>, <span foreground="brown">turnpct</span>)</b>\n\n'+ 
    ...
    ['OnRevSyncPID', 'OnRevSyncPID(,,,,,)', '', 'Output'],
    ['PlayTone', 'PlayTone(,)', '<b>PlayTone (<span foreground="brown">frequency</span>,' +
    ...
    ['PlayTones', 'PlayTones()', '<b>PlayTones (<span foreground="brown">tones[]</span>)</b>\n\n' +
        ...
        '  Wait(SEC_1);\n' +
        '}', 'Sound'],
    ['PlayToneEx', 'PlayToneEx()', '', 'Sound'],
    ['PlayFile', 'PlayFile()', '<b>PlayFile (<span foreground="brown">filename</span> )</b>\n\n' +
    ...
    ['PlayFileEx', 'PlayFileEx(,,)', '', 'Sound'],
    ['PointOut', 'PointOut()', '<b>PointOut (<span foreground="brown">x</span>,' +
    ...
    ['Precedes', 'Precedes()', '<b>Precedes (<span foreground="brown">task1</span>,' +
    ...
    ['Random', 'Random()', '<b>Random (<span foreground="brown">n = 0</span>)</b>\n\n' +
    ...
    ['RectOut', 'RectOut(,,,)', '<b>RectOut (<span foreground="brown">x</span>,' +
    ...
    ['Release', 'Release()', '<b>Release (mutex <span foreground="brown">m</span>)</b>\n\n' +
    ...
    ['RenameFile', 'RenameFile()', '', 'Loader'], 
    ['ResetScreen', 'ResetScreen()', '<b>ResetScreen ()</b>\n\n'+
        'Reset LCD screen. This function lets you restore\n' +
        'the standard NXT running program screen.\n\n' +
        '<b>Example:</b>\n' +
        '  ResetScreen();', 'Display'], 
    ['ResetSensor', 'ResetSensor()', '<b>ResetSensor (<span foreground="brown">port</span>)</b>\n\n' +
    ...
    ['ResetAllTachoCounts', 'ResetAllTachoCounts()', '', 'Output'],
    ['RotateMotor', 'RotateMotor(,,)', '<b>RotateMotor (<span foreground="brown">outputs</span>,' +
    ...
    ['RotateMotorEx', 'RotateMotorEx(,,,,,)', '<b>RotateMotorEx (<span foreground="brown">outputs</span>,' +
    ...
    ['RotateMotorExPID', 'RotateMotorExPID()', '', 'Output'], 
    ['RotateMotorPID', 'RotateMotorPID()', '', 'Output'],
    ['ReadLn', 'ReadLn()', '', 'Loader'], 
    ['ReadLnString', 'ReadLnString()', '', 'Loader'], 
    ['ReceiveRemoteNumber', 'ReceiveRemoteNumber(,,)', '<b>ReceiveRemoteNumber ' +
    ...
    ['ReceiveRemoteString', 'ReceiveRemoteString(,,)', '<b>ReceiveRemoteString ' +
        '(<span foreground="brown">queue</span>, <span foreground="brown">clear</span>, ' +
    ...
    ['Sensor', 'Sensor()', '<b>Sensor (<span foreground="brown">port</span>)</b>\n\n' +
    ...
    ['SensorUS', 'SensorUS()', '<b>SensorUS (<span foreground="brown">port</span> )</b>\n\n' +
    ...
    ['SetSensorSound', 'SetSensorSound()', '<b>SetSensorSound (' +
    ...
    ['SetSensorLowspeed', 'SetSensorLowspeed()', '<b>SetSensorLowspeed (' +
    ...
    ['SetSensor', 'SetSensor()', '<b>SetSensor (<span foreground="brown">port</span>,' +
    ...
    ['SetSensorColorFull', 'SetSensorColorFull()', '<b>SetSensorColorFull (' +
        '<span foreground="brown">port</span>)</b>\n\n' +
    ...
    ['SetSensorColorBlue', 'SetSensorColorBlue()', '<b>SetSensorColorBlue (' +
        '<span foreground="brown">port</span>)</b>\n\n' +
        'Configure an NXT 2.0 full color sensor on the specified\n' +
    ...
    ['SetSensorColorGreen', 'SetSensorColorGreen()', '<b>SetSensorColorGreen (' +
        '<span foreground="brown">port</span>)</b>\n\n' +
        'Configure an NXT 2.0 full color sensor on the specified\n' +
    ...
    ['SetSensorColorRed', 'SetSensorColorRed()', '<b>SetSensorColorRed (' +
        '<span foreground="brown">port</span>)</b>\n\n' +
        'Configure an NXT 2.0 full color sensor on the specified\n' +
    ...
    ['SetSensorColorNone', 'SetSensorColorNone()', '<b>SetSensorColorNone (' +
        '<span foreground="brown">port</span>)</b>\n\n' +
        'Configure an NXT 2.0 full color sensor on the specified\n' +
    ...
    ['SetSensorMode', 'SetSensorMode(,)', '<b>SetSensorMode (<span foreground="brown">port</span>,' +
    ...
    ['SetSensorType', 'SetSensorType(,)', '<b>SetSensorType (' +
    ...
    ['SendRemoteNumber', 'SendRemoteNumber(,,)', '<b>SendRemoteNumber (' +
    ...
    ['SendRemoteString', 'SendRemoteString(,,)', '<b>SendRemoteString (' +
        '<span foreground="brown">conn</span>, <span foreground="brown">queue</span>, ' +
        '<span foreground="brown">str</span>)</b>\n\n' +
    ...
    ['SendResponseNumber', 'SendResponseNumber(,)', '<b>SendResponseNumber (' +
    ...
    ['SendResponseString', 'SendResponseString()', '<b>SendResponseString (' +
    ...
    ['StartTask', 'StartTask()', '<b>StartTask (<span foreground="brown">task</span>)</b>\n\n' +
        'Start the specified task.\n\n' +
        '<b>Parameters</b>\n' +
        '  <span foreground="brown">task</span>   The task to start.\n' +
        '<b>Example:</b>\n' +
        '  StartTask(sound); // start the sound task', 'Command'],
    ['StrCat', 'StrCat()', '<b>StrCat (<span foreground="brown">str1</span>,' +
    ...
    ['StrLen', 'StrLen()', '<b>StrLen (<span foreground="brown">str</span>)</b>\n\n' +
    ...
    ['StrToNum', 'StrToNum()', '<b>StrToNum (<span foreground="brown">str</span>)</b>\n\n' +
    ...
    ['TextOut', 'TextOut(,,)', '<b>TextOut (<span foreground="brown">x</span>,' +
    ...
    ['Off', 'Off()', '<b>Off (<span foreground="brown">outputs</span>)</b>\n\n' +
        'Turn motors off. Turn the specified outputs off (with braking).\n\n' + 
        '<b>Parameters</b>\n' +
        '  <span foreground="brown">outputs</span>  Desired output ports.\n' +
        '<b>Example:</b>\n' +
        '  Off(OUT_A); // turn off output A', 'Output'], 
    ['OpenFileRead', 'OpenFileRead()', '', 'Loader'],
    ['Wait', 'Wait()', '<b>Wait (<span foreground="brown">ms</span>)</b>\n\n' +
        'Make a task sleep for specified amount of time.\n\n' + 
        '<b>Parameters</b>\n' +
        '  <span foreground="brown">ms</span> The number of milliseconds to sleep.\n' +
        '<b>Example:</b>\n' +
        '  Wait(1000);', 'Command'], 
    ['WriteBytes', 'WriteBytes()', '', 'Loader'], 
    ['WriteLn', 'WriteLn()', '', 'Loader'], 
    ['WriteLnString', 'WriteLnString()', '', 'Loader']
]
